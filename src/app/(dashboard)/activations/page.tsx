            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <StatCard
                        ...
                        value={
                            activations.filter(
                                (a) => a.status === "active" || a.status === "installed"
                            ).length
                        }
                        icon={Sparkles}
                    />
                    <StatCard
                        ...
                        value={activations
                            .reduce((sum, a) => sum + (a.expectedFootfall || 0), 0)
                            .toLocaleString()}
                        icon={Users}
                    />
                    <StatCard
                        ...
                        value={formatCurrency(
                            activations.reduce((sum, a) => sum + (a.budget || 0), 0)
                        )}
                        icon={DollarSign}
                    />
                </div>
                ...
                {filteredActivations.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        {filteredActivations.map((activation) => {
                            const typeConfig =
                                ACTIVATION_TYPE_CONFIG[
                                    activation.type as keyof typeof ACTIVATION_TYPE_CONFIG
                                ];
                                            ...
                                            <div className="flex items-center gap-6 text-sm">
                                                {activation.dimensions && (
                                                    <div className="text-center">
                                                        ...
                                                        <p className="font-medium">
                                                            {activation.dimensions.width}x
                                                            {activation.dimensions.depth}{" "}
                                                            {activation.dimensions.unit}
                                                        </p>
                                                    </div>
                                                )}
                                                {activation.expectedFootfall && (
                                                    <div className="text-center">
                                                        ...
                                                        <p className="font-medium">
                                                            {activation.expectedFootfall.toLocaleString()}
                                                        </p>
                                                    </div>
                                                )}
                                                {activation.budget && (
                                                    <div className="text-center">
                                                        ...
                                                        <p className="font-medium">
                                                            {formatCurrency(activation.budget)}
                                                        </p>
                                                    </div>
                                                )}
                                            </div>
