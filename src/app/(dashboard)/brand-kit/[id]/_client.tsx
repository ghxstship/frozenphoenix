...
export function BrandKitDetailClient({
    id,
    initialRecord,
}: {
    id: string;
    ...
    const { data: sbRecord, isLoading } = useBrandKit(id);
    const bk = (sbRecord ?? initialRecord) as Record<string, unknown> | null;
                ...
                <CardContent className="space-y-6">
                    <div>
                        ...
                        <div className="p-4 rounded-lg bg-secondary/30">
                            <p className="text-3xl font-bold" style={{ fontFamily }}>
                                {headingFont}
                            </p>
