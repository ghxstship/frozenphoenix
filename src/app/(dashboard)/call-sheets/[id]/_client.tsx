...
export function CallSheetDetailClient({
    id,
    initialRecord,
}: {
    id: string;
    ...
    const { data: sbRecord, isLoading } = useCallSheet(id);
    const cs = (sbRecord ?? initialRecord) as Record<string, unknown> | null;
    ...
    const config: DetailPageConfig = {
        ...
        tabs: [
            ...
            { id: "crew-db", label: "Crew (DB)", content: <CallSheetCrewTab callSheetId={id} /> },
            {
                id: "crew",
                label: "Crew",
                content: (
        ...
        <DetailPageShell
            ...
            menuItems={[
                { label: "Download PDF", onClick: () => window.print() },
                {
                    ...
                    onClick: () => router.push(`/call-sheets/new?duplicateFrom=${id}`),
                },
                ...crudMenuItems,
            ]}
            avatar={
