...
export default function CampaignsPage() {
    ...
    const config: ListPageConfig = useMemo(
            ...
            stats: [
                {
                    ...
                    icon: Megaphone,
                    compute: () => activeCampaigns.length,
                },
                {
                    label: "Total Budget",
                    icon: DollarSign,
                    compute: () => formatCompactCurrency(totalBudget),
                },
                {
                    label: "Total Spent",
                    icon: BarChart3,
                    compute: () => formatCompactCurrency(totalSpent),
                },
                { label: "Avg ROI", icon: TrendingUp, compute: () => `${avgRoi}x` },
            ],
            contentSlot: (
                <CampaignsContent
                    campaigns={campaigns}
        ...
        [campaigns, channels, assets, kpis, activeCampaigns.length, totalBudget, totalSpent, avgRoi]
    );
