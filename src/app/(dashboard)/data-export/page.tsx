...
const mockExports: ExportRequest[] = [
    { id: "1", format: "json", status: "ready", requestedAt: "2025-02-24 14:30", completedAt: "2025-02-24 14:32", fileSize: "2.4 MB" },
    { id: "2", format: "csv", status: "expired", requestedAt: "2025-02-17 09:00", completedAt: "2025-02-17 09:05", fileSize: "1.8 MB" },
    { id: "3", format: "json", status: "downloaded", requestedAt: "2025-02-20 11:15", completedAt: "2025-02-20 11:18", fileSize: "3.1 MB" },
];

const statusBadge = (status: DataExportStatus) => {
    const variants: Record<DataExportStatus, "success" | "warning" | "secondary" | "destructive" | "default"> = {
        requested: "secondary",
        processing: "warning",
        ready: "success",
        downloaded: "default",
    ...
    return (
        ...
        <div className="space-y-6" id="main-content">
            <div>
                ...
                <p className="text-muted-foreground">Export your personal data (GDPR/CCPA compliant self-service)</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard title="Total Exports" value={mockExports.length} icon={Download} description="All time" />
                <StatCard title="Available" value={mockExports.filter(e => e.status === "ready").length} icon={CheckCircle2} description="Ready to download" />
                <StatCard title="Retention" value="7 days" icon={Clock} description="Auto-expiry" />
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-sm text-muted-foreground mb-4">
                        Export all your personal data including profile, activity history, and preferences.
                    ...
                    <div className="space-y-3">
                        {mockExports.map((exp) => (
                            <div key={exp.id} className="flex items-center justify-between py-3 border-b border-border last:border-0">
                                ...
                                <div className="flex items-center gap-3">
                                    {exp.fileSize && (
                                        <span className="text-xs text-muted-foreground">{exp.fileSize}</span>
                                    )}
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                                Your export will include all personal data associated with your account.
                                Export files are encrypted and automatically deleted after 7 days.
                                To request data deletion, contact your organization administrator.
                            </p>
                        </div>
                    </div>
                </CardContent>
