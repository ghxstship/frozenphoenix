...
export function DeckDetailClient({
    ...
    const { data: sbRecord, isLoading } = useDeck(id);
    ...
    const [slides, setSlides] = useState<Slide[]>([
        ...
        },
        {
            ...
            body: "A 3-day immersive brand activation.",
            notes: "",
        },
        {
            id: "3",
            ...
            body: "Fabrication: 35% | AV/Tech: 25% | Talent: 15%",
            notes: "",
        },
    ]);
    ...
    const addSlide = (type: SlideType) => {
        ...
        setSlides([...slides.slice(0, insertAt), newSlide, ...slides.slice(insertAt)]);
    ...
    const record = (sbRecord ?? initialRecord) as Record<string, unknown> | null;
                ...
                menuItems={[
                    {
                        ...
                        onClick: () => router.push(`/decks/new?duplicateFrom=${id}`),
                    },
                    ...crudMenuItems,
                ]}
                avatar={
