...
import { useDeleteEstimate, useEstimate, useUpdateEstimate } from "@/lib/supabase/hooks-pages";
    ...
    return (
        <DetailPageShell
            ...
            menuItems={[
                {
                    label: "Edit Estimate",
                    onClick: () => router.push(`/estimates/${entityId}/edit`),
                },
                {
                    label: "Duplicate",
                    onClick: () => router.push(`/estimates/new?duplicateFrom=${entityId}`),
                },
                {
                    label: "Convert to Invoice",
                    onClick: () => router.push(`/invoices/new?fromEstimate=${entityId}`),
                },
                ...crudMenuItems,
            ]}
            avatar={
