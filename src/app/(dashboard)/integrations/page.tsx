...
import { AlertTriangle, CheckCircle2, Link2, Plus, RefreshCw, Unplug, Wifi } from "lucide-react";
                        ...
                        <CardContent className="py-16">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-sm text-muted-foreground mt-1 max-w-md">
                                    Connect your ticketing providers (Eventbrite, Front Gate
                                    Tickets) and POS systems (Square) to sync data automatically.
                                </p>
