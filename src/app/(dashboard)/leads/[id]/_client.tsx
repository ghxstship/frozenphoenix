...
export function LeadDetailClient({
    ...
    const { data: sbActivity } = useRecordActivityLog("lead", id);
    const { data: sbComments } = useRecordComments("lead", id);
        ...
        <Card>
            ...
            <CardContent className="space-y-2">
                ...
                <Button
                    ...
                    size="sm"
                    className="w-full justify-start"
                    onClick={() => router.push(`/deals/new?fromLead=${id}`)}
                >
    ...
    const config: DetailPageConfig = {
        ...
        tabs: [
            { id: "pipeline-stats", label: "Pipeline Stats", content: <LeadPipelineStatsTab /> },
            {
                id: "convert",
                label: "Convert",
                content: (
    ...
    const rec = (lead as unknown as Record<string, unknown>) ?? initialRecord;
    return (
        <DetailPageShell
            config={config}
            id={id}
