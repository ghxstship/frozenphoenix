...
import { AlertTriangle, CheckCircle2, Clock, HardHat } from "lucide-react";
...
const mockCrew: MockLiveCrew[] = [
    ...
    },
    {
        ...
        status: "checked_in",
        checkedInAt: "06:15",
        radioCallsign: "AUDIO-1",
        hoursWorked: 8.0,
        overtimeFlagged: false,
    },
    {
        id: "3",
        name: "Morgan Blake",
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard
                    title="Checked In"
                    value={`${checkedIn}/${mockCrew.length}`}
                    icon={CheckCircle2}
                />
            ...
            <div className="space-y-2">
                {filtered.map((member, i) => (
                    <StaggerItem key={member.id} index={i} stagger="tight">
                        <Card
                            className={`hover:shadow-sm transition-all ${member.overtimeFlagged ? "border-l-2 border-l-warning" : ""}`}
                        >
