...
const mockDepts: MockDeptStatus[] = [
    { id: "1", department: "Audio", lead: "Sam Chen", status: "ready", crewCount: 6, crewCheckedIn: 6 },
    { id: "2", department: "Lighting", lead: "Alex Torres", status: "ready", crewCount: 8, crewCheckedIn: 8 },
    { id: "3", department: "Video", lead: "Morgan Blake", status: "setting_up", crewCount: 5, crewCheckedIn: 5 },
    { id: "4", department: "Rigging", lead: "Lee Park", status: "ready", crewCount: 4, crewCheckedIn: 4 },
    { id: "5", department: "Stage", lead: "Pat Davis", status: "active", crewCount: 10, crewCheckedIn: 10 },
    { id: "6", department: "FOH", lead: "Jordan Lee", status: "setting_up", crewCount: 12, crewCheckedIn: 10, issues: "2 crew delayed — ETA 15 min" },
    { id: "7", department: "Security", lead: "Chris Ruiz", status: "ready", crewCount: 8, crewCheckedIn: 8 },
    { id: "8", department: "Catering", lead: "Taylor Kim", status: "not_checked_in", crewCount: 6, crewCheckedIn: 0 },
];
...
export default function DepartmentStatusPage() {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <PageHeader title="Department Status" description="Real-time department readiness and crew check-in status" />

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard title="Departments Ready" value={`${ready}/${mockDepts.length}`} icon={CheckCircle2} />
                <StatCard title="Issues Flagged" value={withIssues} icon={AlertTriangle} />
                <StatCard title="Crew Checked In" value={`${checkedIn}/${totalCrew}`} icon={Users} />
                        ...
                        <CardContent className="py-4">
                            ...
                            {dept.issues && (
                                <p className="text-[10px] text-warning mt-2 flex items-center gap-1">
                                    <AlertTriangle className="h-3 w-3 shrink-0" />{dept.issues}
                                </p>
                            )}
                        </CardContent>
                    </Card>
