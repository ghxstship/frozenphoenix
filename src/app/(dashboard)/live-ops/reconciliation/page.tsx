...
const mockItems: MockReconciliation[] = [
    {
        id: "1",
        assetName: "Meyer Sound LEOPARD Line Array (x8)",
        barcode: "MSL-2024-001",
    ...
    },
    {
        ...
        notes: "1 unit missing — last seen stage left truss",
    },
    {
        id: "3",
        assetName: "Disguise D3 Media Server",
        barcode: "DG-D3-007",
        conditionOnArrival: "excellent",
        ...
        notes: "Fan failure during show — overheated",
    },
    {
        id: "4",
        assetName: "CM Lodestar 1-Ton Chain Hoist (x6)",
        barcode: "CM-LS1T-019",
        conditionOnArrival: "good",
    ...
    {
        id: "5",
        assetName: "Crowd Barrier Sections (x40)",
        barcode: "CB-STD-100",
        ...
        quantityMissing: 2,
        quantityDamaged: 0,
        notes: "2 sections unaccounted — checking loading dock",
    },
    {
        id: "6",
        assetName: "XL Video LED Panel P2.9 (x24)",
        barcode: "XLV-P29-060",
        conditionOnArrival: "excellent",
        conditionOnReturn: "good",
        status: "reconciled",
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard
                    title="Reconciled"
                    value={`${reconciled}/${mockItems.length}`}
                    icon={CheckCircle2}
                />
            ...
            <div className="space-y-2">
                {filtered.map((item, i) => (
                    <StaggerItem key={item.id} index={i} stagger="tight">
                        <Card
                            className={`hover:shadow-sm transition-all ${item.status === "discrepancy" ? "border-l-2 border-l-destructive" : item.status === "reconciled" ? "border-l-2 border-l-success" : ""}`}
                        >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-3 text-[10px] text-muted-foreground mt-0.5">
                                            <span>
                                                Arrival:{" "}
                                                <StatusBadge
                                                    status={item.conditionOnArrival}
                                                    className="text-[9px]"
                                                />
                                            </span>
                                            <span>
