...
const mockVips: MockVip[] = [
    {
        id: "1",
        name: "Sarah Mitchell",
        affiliation: "Title Sponsor — Acme Corp",
        tier: "platinum",
        status: "in_venue",
        expectedArrival: "17:00",
        actualArrival: "16:45",
        escortName: "Casey Kim",
        zoneAccess: ["VIP Lounge", "Backstage", "Main Stage"],
        specialRequests: "Vegetarian meal",
    },
    {
        id: "2",
        name: "David Park",
        affiliation: "CEO — BrandCo",
        tier: "gold",
        status: "arrived",
        expectedArrival: "17:30",
        actualArrival: "17:25",
        escortName: "Jordan Lee",
        zoneAccess: ["VIP Lounge", "Main Stage"],
    },
    {
        id: "3",
        name: "Lisa Chen",
        affiliation: "VP Marketing — TechStart",
        tier: "gold",
        status: "in_venue",
    ...
    },
    {
        ...
        zoneAccess: ["VIP Lounge"],
    },
    {
        id: "5",
        name: "Emma Torres",
        affiliation: "Press — Vogue",
        tier: "silver",
        status: "expected",
        expectedArrival: "18:30",
        zoneAccess: ["VIP Lounge", "Press Box"],
    },
    {
        id: "6",
        name: "James Wright",
        affiliation: "Artist Management",
        tier: "platinum",
        status: "departed",
        expectedArrival: "15:00",
        actualArrival: "14:50",
        escortName: "Pat Davis",
        zoneAccess: ["VIP Lounge", "Backstage", "Green Room"],
    },
];
...
export default function VipPage() {
    ...
    const filtered = mockVips.filter(
        (v) =>
            !search ||
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-right text-sm shrink-0">
                                        <p className="font-medium">
                                            {vip.actualArrival ?? vip.expectedArrival}
                                        </p>
                                        <p className="text-[10px] text-muted-foreground">
                                            {vip.actualArrival ? "arrived" : "expected"}
                                        </p>
                                        {vip.escortName && (
                                            <p className="text-[10px] text-muted-foreground mt-0.5">
                                                Escort: {vip.escortName}
                                            </p>
                                        )}
                                    </div>
                                </div>
