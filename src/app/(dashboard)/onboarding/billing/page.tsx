...
import { ArrowRight, Construction, CreditCard } from "lucide-react";
        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <div className="w-full max-w-lg space-y-8">
                ...
                <div className="text-center space-y-2">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Configure billing</h1>
                ...
                <div className="rounded-xl border border-border bg-card p-8 text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                            Billing integration is being finalized. You can continue using the
                            platform and configure billing later from your organization settings.
                        </p>
                    </div>
                </div>
