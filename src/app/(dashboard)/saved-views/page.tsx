...
const mockViews: SavedView[] = [
    {
        ...
        description: "Tasks assigned to me, filtered by in-progress status",
        entityType: "Tasks",
        viewType: "board",
        visibility: "private",
        owner: "Sarah Chen",
    ...
    {
        id: "2",
        name: "Project Profitability Overview",
        description: "All projects with budget vs actual comparison",
        entityType: "Projects",
        viewType: "table",
    ...
    },
    {
        ...
        description: "Pipeline deals grouped by stage with probability",
        entityType: "Deals",
        viewType: "board",
        visibility: "team",
        owner: "Lisa Wang",
    ...
    {
        id: "4",
        name: "Team Schedule — Next 2 Weeks",
        description: "Resource bookings for all team members",
        entityType: "Bookings",
        viewType: "timeline",
        visibility: "team",
        owner: "David Kim",
    ...
    },
    {
        ...
        description: "Client invoices past due date, sorted by amount",
        entityType: "Invoices",
        viewType: "list",
        visibility: "organization",
        owner: "Sarah Chen",
    ...
    {
        id: "6",
        name: "Crew Availability Calendar",
        description: "All crew members with time-off and bookings",
        entityType: "Crew",
        viewType: "calendar",
        visibility: "team",
        owner: "Tom Harris",
    ...
    {
        id: "7",
        name: "Production Timeline — Q1",
        description: "Gantt view of all Q1 production milestones",
        entityType: "Projects",
        viewType: "gantt",
        visibility: "organization",
        owner: "Mike Johnson",
    ...
    {
        id: "8",
        name: "Expense Approvals Queue",
        description: "Pending expenses awaiting my approval",
        entityType: "Expenses",
        viewType: "list",
        visibility: "private",
        owner: "Mike Johnson",
                ...
                <CardContent className="flex items-center gap-4 py-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 mt-1 text-[10px] text-muted-foreground">
                            ...
                            <span>
                                <Eye className="h-2.5 w-2.5 inline" /> {view.usageCount} views
                            </span>
