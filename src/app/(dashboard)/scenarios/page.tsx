                ...
                >
                            ...
                            <CardContent className="flex items-center justify-between py-3">
                                <div className="flex items-center gap-2 text-sm">
                                    ...
                                    <span className="font-medium">
                                        Compare {activeScenarios.length} active scenarios
                                        side-by-side
                                    </span>
                                </div>
                                <Button
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                {(() => {
                                    const allMetrics = [
                                        ...new Set(
                                            activeScenarios.flatMap((s) =>
                                                s.outcomes.map((o) => o.metric)
                                            )
                                        ),
                                    ];
                                    return allMetrics.map((metric) => (
                                        ...
                                        >
                                            ...
                                            {activeScenarios.map((s) => {
                                                ...
                                                const variance =
                                                    outcome.projectedValue - outcome.baseValue;
                                                const isPositive =
                                                    metric.includes("Cost") ||
                                                    metric.includes("Idle")
                                                        ? variance <= 0
                                                        : variance >= 0;
                                                const fmt = (v: number) =>
                    ...
                    {filtered.length === 0 ? (
                        <EmptyState
                            ...
                            description={
                                search ? "Try adjusting your search" : "No scenarios created yet"
                            }
                        />
                    ) : (
