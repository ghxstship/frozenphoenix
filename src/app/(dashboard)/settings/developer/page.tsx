...
import { BookOpen, Copy, Eye, EyeOff, Key, Plus, Shield, Trash2, Webhook } from "lucide-react";

type DevTab = "api-keys" | "webhooks" | "docs";
const TAB_VALUES = ["api-keys", "webhooks", "docs"] as const;
...
export default function DeveloperPortalPage() {
    const [activeTab, setActiveTab] = useQueryTabState<DevTab>({
        key: "tab",
        ...
        <PermissionGate resource="settings" action="read">
            <div className="space-y-6 animate-fade-in">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <StatCard title="Active API Keys" value={activeKeys.length} icon={Key} />
                    <StatCard title="Revoked Keys" value={revokedKeys.length} icon={Shield} />
                    <StatCard title="API Version" value="v1" icon={BookOpen} />
                </div>

                <TabBar
                    idPrefix="dev-portal"
                    ariaLabel="Developer portal sections"
                    items={[
                        {
                            id: "api-keys",
                            label: "API Keys",
                    ...
                    value={activeTab}
                    onValueChange={(t) => setActiveTab(t as DevTab)}
                />
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="rounded-lg bg-muted/50 p-4">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Default: 60 requests per minute. Check response headers for
                                    current limits:
                                </p>
