...
import { Bell, Clock, Loader2, Mail, MessageSquare, Moon, Smartphone, Zap } from "lucide-react";
...
export default function NotificationSettingsPage() {
    ...
    if (isLoading) {
        return (
            <PageShell title="Notification Preferences">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-1">
                        ...
                        <ChannelRow
                            ...
                            onToggle={() =>
                                handleToggle("push_enabled", getBool("push_enabled", true))
                            }
                        />
                        <ChannelRow
                            icon={Smartphone}
