...
const mockRequests: LeaveRequest[] = [
    { id: "1", person: "Sarah Chen", type: "vacation", startDate: "2026-03-15", endDate: "2026-03-22", days: 5, status: "pending", reason: "Spring break trip", approver: "Mike Johnson" },
    { id: "2", person: "David Kim", type: "sick", startDate: "2026-02-24", endDate: "2026-02-25", days: 2, status: "approved", reason: "Not feeling well", approver: "Sarah Chen" },
    { id: "3", person: "Lisa Wang", type: "training", startDate: "2026-03-05", endDate: "2026-03-07", days: 3, status: "approved", reason: "AWS certification boot camp", approver: "Mike Johnson" },
    { id: "4", person: "Tom Harris", type: "personal", startDate: "2026-03-10", endDate: "2026-03-10", days: 1, status: "pending", reason: "Apartment move", approver: "Sarah Chen" },
    { id: "5", person: "Mike Johnson", type: "vacation", startDate: "2026-04-01", endDate: "2026-04-10", days: 8, status: "pending", reason: "Family vacation", approver: "Director" },
    { id: "6", person: "Sarah Chen", type: "sick", startDate: "2026-02-10", endDate: "2026-02-10", days: 1, status: "approved", reason: "Doctor appointment", approver: "Mike Johnson" },
];
...
export default function TimeOffPage() {
    ...
    const totalDaysOff = mockRequests.filter((r) => r.status === "approved").reduce((s, r) => s + r.days, 0);
    ...
    return (
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard title="Pending Requests" value={pending} description="awaiting approval" icon={Clock} />
                <StatCard title="Approved This Month" value={approved} description="requests" icon={CheckCircle2} />
                <StatCard title="Days Used (Team)" value={totalDaysOff} description="this quarter" icon={CalendarDays} />
                ...
                <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {balances.map((b) => {
                            ...
                            return (
                                <div key={b.type} className="p-4 rounded-xl bg-secondary/50 space-y-2">
            ...
            <div className="space-y-2">
                {filtered.map((req) => {
                    ...
                    return (
                        <Card key={req.id} className="hover:bg-secondary/30 transition-colors cursor-pointer">
                            <CardContent className="flex items-center gap-4 py-3">
                                ...
                                <div className="text-right shrink-0">
                                    ...
                                    <p className="text-[10px] text-muted-foreground">{req.startDate}{req.days > 1 ? ` — ${req.endDate}` : ""}</p>
                                </div>
                                {req.status === "pending" && (
