...
import { useInvitationsList, useUpdateInvitation } from "@/lib/supabase";
...
export function InvitationsPageClient() {
    ...
    const config: DashboardPageConfig = {
        ...
        stats: [
            { label: "Pending", icon: Clock, compute: () => pendingCount },
            { label: "Accepted", icon: CheckCircle2, compute: () => acceptedCount },
