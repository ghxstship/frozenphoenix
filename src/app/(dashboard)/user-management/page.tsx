                    ...
                    <DataTable
                        ...
                        columns={[
                                ...
                                render: (_value, row) => (
                                    <div className="flex items-center gap-3">
                                        <div className="h-9 w-9 rounded-full bg-primary/10 flex items-center justify-center text-xs font-bold shrink-0">
                                            {row.displayName.split(" ").map((n: string) => n[0]).join("")}
                                        </div>
                                        <div>
                            ...
                            },
                            {
                                ...
                                sortable: true,
                                render: (_value, row) => (
                                    <span className="text-sm text-muted-foreground">{row.jobTitle || "—"}</span>
                                ),
                            },
                            {
                                id: "role",
                                ...
                                sortable: true,
                                render: (_value, row) => {
                                    const config = PERMISSION_LEVEL_MAP[row.role as PermissionLevel];
                                    return config ? (
