...
const COMPLIANCE_STATUSES: ComplianceDocStatus[] = [
    "not_submitted",
    "pending_review",
    "approved",
    "rejected",
...
export function VendorCompliancePageClient() {
    ...
    const contentSlot = (
        <div className="density-gap-page">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base flex items-center gap-2">
                        <FileText className="h-4 w-4" /> Compliance Documents ({filtered.length})
                    </CardTitle>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base flex items-center gap-2">
                        <ShieldCheck className="h-4 w-4" /> Compliance Requirements (
                        {requirements.length})
                    </CardTitle>
                </CardHeader>
                <CardContent>
    ...
    const config: ListPageConfig = {
        entityKey: "vendor_compliance",
        resource: "vendor_compliance",
        action: "read",
        title: "Vendor Compliance",
        description:
            "Document tracking, verification status, and compliance requirement management for all vendors",
        headerActions: (
        ...
        stats: [
            { label: "Approved Docs", icon: CheckCircle2, compute: () => approved },
            { label: "Pending Review", icon: Clock, compute: () => pendingReview },
