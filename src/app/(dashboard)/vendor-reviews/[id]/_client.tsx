...
const CONFIG: DetailPageConfig = {
    ...
    tabs: [
        ...
        { id: "review-cycles", label: "Review Cycles", content: <ReviewCyclesTab /> },
        { id: "feedback", label: "Feedback", content: <ReviewFeedbackTab /> },
    ],
};

export function VendorReviewDetailClient({
    id,
    initialRecord,
}: {
    id: string;
    ...
    const { data: review, isLoading } = useVendorReview(id);
    ...
    return (
        <DetailPageShell
            config={CONFIG}
            id={id}
            record={(review ?? initialRecord) as Record<string, unknown> | null}
