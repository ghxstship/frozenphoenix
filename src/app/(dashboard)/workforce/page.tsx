    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatCard title="Compliance Issues" value={complianceIssues} icon={AlertTriangle} />
            ...
            <div className="flex flex-wrap items-center gap-3">
                ...
                <select value={classFilter} onChange={e => setClassFilter(e.target.value)} className="h-9 rounded-md border border-input bg-background px-3 text-sm">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-3 text-xs text-muted-foreground">
                                        ...
                                        <span className="px-1.5 py-0.5 rounded-full bg-muted text-[10px]">
                                            {CLASSIFICATION_LABELS[worker.primaryClassification]}
                                        </span>
                                        {worker.department && (
                                            <span className="hidden sm:inline">{worker.department}</span>
                                        )}
                                        {worker.homeBase && (
                                            <span className="hidden md:flex items-center gap-1">
                                                <MapPin className="h-3 w-3" />{worker.homeBase}
                                            </span>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="hidden sm:flex items-center gap-4 shrink-0">
                                    <div className="text-center">
                                        ...
                                        <ComplianceBar score={worker.complianceScore || 0} />
                                    </div>
                                    <div className="text-center">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs font-medium">{worker.activeEngagements || 0}</p>
                                    </div>
                                </div>
