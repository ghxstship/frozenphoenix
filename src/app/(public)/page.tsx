...
import { useCreateLead, usePublicTestimonials, useReviewStats } from "@/lib/supabase";
import { usePublicCaseStudies } from "@/lib/supabase";
    ...
    const handleSubmit = async () => {
        ...
        try {
            await createLead.mutateAsync({
                ...
                project_type: (formData.projectType || undefined) as
                    | "brand_activation"
                    | "stage_set_design"
                    ...
                    | "other"
                    | undefined,
                budget_range: (formData.budgetRange || undefined) as
                    | "under_50k"
                    | "50k_150k"
                    | "150k_500k"
                    | "500k_1m"
            ...
            <section className="relative pt-32 pb-20 px-6 overflow-hidden">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
                        From concept to load-out, we architect and fabricate world-class brand
                        activations, stages, and immersive environments for the world&apos;s most
                        ambitious brands.
                    </p>
                        ...
                        {submitted ? (
                            ...
                            <div className="spatial-card p-6 space-y-4">
                                ...
                                >
                                    ...
                                    <option value="immersive_installation">
                                ...
                                <Button
                                    ...
                                    disabled={
                                        createLead.isPending || !formData.name || !formData.email
                                    }
                                >
                        ...
                        {[
                            {
                                ...
                                desc: "Concept development, 3D renders, and client presentations powered by live project data.",
                            },
                            {
                                icon: Package,
                                title: "Fabrication",
                                desc: "Steel, wood, print — precision fabrication with real-time progress tracking.",
                            },
                            {
                                icon: BarChart3,
                                title: "Production Management",
                                desc: "Gantt scheduling across 7 phases with dependency tracking and crew coordination.",
                            },
                            {
                                icon: Shield,
                                title: "Compliance & Safety",
                                desc: "OSHA certification tracking, COI validation, and zero-trust access control.",
                            },
                            {
                                icon: Zap,
                                title: "Live Activation",
                                desc: "Run-of-show management, real-time crew dispatch, and on-site problem solving.",
                            },
                            {
                                icon: Star,
                                title: "Case Studies",
                                desc: "Auto-generated project case studies with KPI metrics, published with one click.",
                            },
                        ].map((service, i) => (
                ...
                <section className="py-20 px-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-14">
                            ...
                            <p className="text-muted-foreground">
                                Real feedback from real productions.
                            </p>
                        </div>
                                ...
                                <div key={testimonial.id} className="spatial-card p-6">
                                    <div className="flex items-center gap-1 mb-4">
                                        {[...Array(5)].map((_, i) => (
                                            <Star
                                                key={i}
                                                className={`h-4 w-4 ${i < (testimonial.rating || 5) ? "text-star-rating fill-star-rating" : "text-muted"}`}
                                            />
                                        ))}
                                    </div>
