    ...
    "pointer-events-auto relative flex w-full items-start gap-3 overflow-hidden rounded-lg border p-4 shadow-lg transition-all",
    {
        variants: {
            variant: {
                ...
                warning: "bg-background border-warning/30 text-warning",
                destructive: "bg-background border-destructive/30 text-destructive",
                info: "bg-background border-info/30 text-info",
            },
        },
...
function ToastViewport() {
    ...
    return (
        <div
            className="fixed bottom-4 right-4 z-[var(--z-toast)] flex flex-col gap-2 w-full max-w-sm pointer-events-none"
            role="region"
