...
export const ACTIVATION_STATUS_MAP = toEnumMap(ACTIVATION_STATUSES);
...
export const ACTIVITY_STATUS_MAP = toEnumMap(ACTIVITY_STATUSES);
...
export const ACTIVITY_TYPE_MAP = toEnumMap(ACTIVITY_TYPES);
...
export const DEPARTMENT_MAP = toEnumMap(DEPARTMENTS);
...
export const PROCUREMENT_STATUS_MAP = toEnumMap(PROCUREMENT_STATUSES);
...
export const EMPLOYMENT_TYPE_MAP = toEnumMap(EMPLOYMENT_TYPES);
...
export const CREW_STATUS_MAP = toEnumMap(CREW_STATUSES);
...
export const SHIFT_STATUS_MAP = toEnumMap(SHIFT_STATUSES);
...
export const ASSET_OWNERSHIP_MAP = toEnumMap(ASSET_OWNERSHIP_TYPES);
...
export const ASSET_ASSIGNMENT_STATUS_MAP = toEnumMap(ASSET_ASSIGNMENT_STATUSES);
...
export const SHIPMENT_TYPE_MAP = toEnumMap(SHIPMENT_TYPES);
...
export const SHIPMENT_PRIORITY_MAP = toEnumMap(SHIPMENT_PRIORITIES);
...
export const VEHICLE_STATUS_MAP = toEnumMap(VEHICLE_STATUSES);
...
export const VEHICLE_OWNERSHIP_MAP = toEnumMap(VEHICLE_OWNERSHIP_TYPES);
...
export const BUDGET_CATEGORY_MAP = toEnumMap(BUDGET_CATEGORIES);
...
export const EXPENSE_STATUS_MAP = toEnumMap(EXPENSE_STATUSES);
...
export const PAYMENT_METHOD_MAP = toEnumMap(PAYMENT_METHODS);

export const INVOICE_TYPES = [
    { value: "vendor", label: "Vendor", variant: "default" as const },
    { value: "client", label: "Client", variant: "info" as const },
] as const;
export const INVOICE_TYPE_MAP = toEnumMap(INVOICE_TYPES);
...
export const TIME_ENTRY_STATUS_MAP = toEnumMap(TIME_ENTRY_STATUSES);
...
export const PAYROLL_STATUS_MAP = toEnumMap(PAYROLL_STATUSES);
...
export const INCIDENT_TYPE_MAP = toEnumMap(INCIDENT_TYPES);
...
export const INCIDENT_STATUS_MAP = toEnumMap(INCIDENT_STATUSES);
...
export const SOP_STATUS_MAP = toEnumMap(SOP_STATUSES);
...
export const CHECKLIST_STATUS_MAP = toEnumMap(CHECKLIST_STATUSES);
...
export const MILESTONE_STATUS_MAP = toEnumMap(MILESTONE_STATUSES);
...
export const DELIVERABLE_STATUS_MAP = toEnumMap(DELIVERABLE_STATUSES);
...
export const AVAILABILITY_STATUS_MAP = toEnumMap(AVAILABILITY_STATUSES);
...
export const ASSIGNMENT_STATUS_MAP = toEnumMap(ASSIGNMENT_STATUSES);
...
export const RATE_TYPE_MAP = toEnumMap(RATE_TYPES);
...
export const EVENT_TYPE_MAP = toEnumMap(EVENT_TYPES);
...
export const EVENT_STATUS_MAP = toEnumMap(EVENT_STATUSES);
...
export const PRODUCTION_PHASE_MAP = toEnumMap(PRODUCTION_PHASES);
...
export const PROJECT_TYPE_MAP = toEnumMap(PROJECT_TYPES);
...
export const LEAD_STATUS_MAP = toEnumMap(LEAD_STATUSES);
...
export const PROJECT_TYPE_INTEREST_MAP = toEnumMap(PROJECT_TYPE_INTERESTS);
...
export const BUDGET_RANGE_MAP = toEnumMap(BUDGET_RANGES);
...
export const TESTIMONIAL_STATUS_MAP = toEnumMap(TESTIMONIAL_STATUSES);
...
export const CUSTOM_FIELD_TYPE_MAP = toEnumMap(CUSTOM_FIELD_TYPES);
...
export const ENTITY_TYPE_MAP = toEnumMap(ENTITY_TYPES);
...
export const AUTOMATION_TRIGGER_MAP = toEnumMap(AUTOMATION_TRIGGERS);
...
export const AUTOMATION_ACTION_MAP = toEnumMap(AUTOMATION_ACTIONS);
...
export const BOOKING_STATUS_MAP = toEnumMap(BOOKING_STATUSES);
...
export const BOOKING_TYPE_MAP = toEnumMap(BOOKING_TYPES);
...
export const TIME_OFF_TYPE_MAP = toEnumMap(TIME_OFF_TYPES);
...
export const TIME_OFF_STATUS_MAP = toEnumMap(TIME_OFF_STATUSES);
...
export const PROPOSAL_STATUS_MAP = toEnumMap(PROPOSAL_STATUSES);
...
export const BILLING_TYPE_MAP = toEnumMap(BILLING_TYPES);
...
export const PAYMENT_STATUS_MAP = toEnumMap(PAYMENT_STATUSES);
...
export const WIDGET_TYPE_MAP = toEnumMap(WIDGET_TYPES);
...
export const APPROVAL_STEP_TYPE_MAP = toEnumMap(APPROVAL_STEP_TYPES);
...
export const SOW_DELIVERABLE_STATUS_MAP = toEnumMap(SOW_DELIVERABLE_STATUSES);
...
export const SOW_DELIVERABLE_TYPE_MAP = toEnumMap(SOW_DELIVERABLE_TYPES);
...
export const INVOICE_LINE_ITEM_TYPE_MAP = toEnumMap(INVOICE_LINE_ITEM_TYPES);
...
export const CLIENT_INVOICE_STATUS_MAP = toEnumMap(CLIENT_INVOICE_STATUSES);
...
export const VENDOR_TYPE_MAP = toEnumMap(VENDOR_TYPES);
...
export const VENDOR_STATUS_MAP = toEnumMap(VENDOR_STATUSES);
...
export const ONBOARDING_STATUS_MAP = toEnumMap(ONBOARDING_STATUSES);
...
export const COMPLIANCE_DOC_TYPE_MAP = toEnumMap(COMPLIANCE_DOC_TYPES);
...
export const COMPLIANCE_DOC_STATUS_MAP = toEnumMap(COMPLIANCE_DOC_STATUSES);
...
export const WORK_ORDER_STATUS_MAP = toEnumMap(WORK_ORDER_STATUSES);
...
export const DISPATCH_STATUS_MAP = toEnumMap(DISPATCH_STATUSES);
...
export const BID_STATUS_MAP = toEnumMap(BID_STATUSES);
...
export const VENDOR_REVIEW_TYPE_MAP = toEnumMap(VENDOR_REVIEW_TYPES);
...
export const JOB_CHECKLIST_STATUS_MAP = toEnumMap(JOB_CHECKLIST_STATUSES);
...
export const SERVICE_REQUEST_STATUS_MAP = toEnumMap(SERVICE_REQUEST_STATUSES);
...
export const SERVICE_REQUEST_SOURCE_MAP = toEnumMap(SERVICE_REQUEST_SOURCES);
...
export const WORKER_LIFECYCLE_STATUS_MAP = toEnumMap(WORKER_LIFECYCLE_STATUSES);
...
export const WORKER_CLASSIFICATION_MAP = toEnumMap(WORKER_CLASSIFICATIONS);
...
export const TAX_CLASSIFICATION_MAP = toEnumMap(TAX_CLASSIFICATIONS);
...
export const LIFECYCLE_STEP_STATUS_MAP = toEnumMap(LIFECYCLE_STEP_STATUSES);
...
export const REVIEW_TARGET_TYPE_MAP = toEnumMap(REVIEW_TARGET_TYPES);
...
export const COMPLIANCE_SCOPE_MAP = toEnumMap(COMPLIANCE_SCOPES);
...
export const IC_ASSESSMENT_METHOD_MAP = toEnumMap(IC_ASSESSMENT_METHODS);
...
export const IC_ASSESSMENT_RESULT_MAP = toEnumMap(IC_ASSESSMENT_RESULTS);
...
export const OPPORTUNITY_ACTIVITY_TYPE_MAP = toEnumMap(OPPORTUNITY_ACTIVITY_TYPES);
...
export const REVENUE_RECOGNITION_TYPE_MAP = toEnumMap(REVENUE_RECOGNITION_TYPES);
...
export const CREATIVE_REVIEW_GATE_MAP = toEnumMap(CREATIVE_REVIEW_GATES);
...
export const CAMPAIGN_CHANNEL_TYPE_MAP = toEnumMap(CAMPAIGN_CHANNEL_TYPES);
...
export const CAMPAIGN_CHANNEL_STATUS_MAP = toEnumMap(CAMPAIGN_CHANNEL_STATUSES);
...
export const CAMPAIGN_ASSET_ROLE_MAP = toEnumMap(CAMPAIGN_ASSET_ROLES);
...
export const GUIDELINE_SECTION_TYPE_MAP = toEnumMap(GUIDELINE_SECTION_TYPES);
...
export const ATTRIBUTION_MODEL_MAP = toEnumMap(ATTRIBUTION_MODELS);
...
export const KPI_METRIC_TYPE_MAP = toEnumMap(KPI_METRIC_TYPES);
...
export const INSURANCE_POLICY_TYPE_MAP = toEnumMap(INSURANCE_POLICY_TYPES);
...
export const INSURANCE_POLICY_STATUS_MAP = toEnumMap(INSURANCE_POLICY_STATUSES);
...
export const INSURANCE_HOLDER_TYPE_MAP = toEnumMap(INSURANCE_HOLDER_TYPES);
...
export const CONTRACT_CATEGORY_MAP = toEnumMap(CONTRACT_CATEGORIES);
...
export const CONTRACT_CONFIDENTIALITY_MAP = toEnumMap(CONTRACT_CONFIDENTIALITIES);
...
export const CONTRACT_AMENDMENT_STATUS_MAP = toEnumMap(CONTRACT_AMENDMENT_STATUSES);
...
export const CLAUSE_TYPE_MAP = toEnumMap(CLAUSE_TYPES);
...
export const CLAUSE_RISK_LEVEL_MAP = toEnumMap(CLAUSE_RISK_LEVELS);
...
export const OBLIGATION_PARTY_MAP = toEnumMap(OBLIGATION_PARTIES);
...
export const OBLIGATION_STATUS_MAP = toEnumMap(OBLIGATION_STATUSES);
...
export const IP_ASSET_TYPE_MAP = toEnumMap(IP_ASSET_TYPES);
...
export const IP_LICENSE_TYPE_MAP = toEnumMap(IP_LICENSE_TYPES);
...
export const PERMIT_TYPE_MAP = toEnumMap(PERMIT_TYPES);
...
export const PERMIT_STATUS_MAP = toEnumMap(PERMIT_STATUSES);
...
export const PERMIT_ENTITY_TYPE_MAP = toEnumMap(PERMIT_ENTITY_TYPES);
...
export const ENGINEERING_APPROVAL_TYPE_MAP = toEnumMap(ENGINEERING_APPROVAL_TYPES);
...
export const ENGINEERING_APPROVAL_STATUS_MAP = toEnumMap(ENGINEERING_APPROVAL_STATUSES);
...
export const COMPLIANCE_CHECKLIST_TYPE_MAP = toEnumMap(COMPLIANCE_CHECKLIST_TYPES);
...
export const COMPLIANCE_CHECKLIST_STATUS_MAP = toEnumMap(COMPLIANCE_CHECKLIST_STATUSES);
...
export const ASSET_CERTIFICATION_TYPE_MAP = toEnumMap(ASSET_CERTIFICATION_TYPES);
...
export const ASSET_CERTIFICATION_STATUS_MAP = toEnumMap(ASSET_CERTIFICATION_STATUSES);
...
export const APPROVAL_STATUS_MAP = toEnumMap(APPROVAL_STATUSES);
...
export const APPROVAL_ENTITY_TYPE_MAP = toEnumMap(APPROVAL_ENTITY_TYPES);
...
export const PAYMENT_APPROVAL_TYPE_MAP = toEnumMap(PAYMENT_APPROVAL_TYPES);
...
export const REQUISITION_STATUS_MAP = toEnumMap(REQUISITION_STATUSES);
...
export const REQUISITION_URGENCY_MAP = toEnumMap(REQUISITION_URGENCIES);
...
export const GOODS_RECEIPT_STATUS_MAP = toEnumMap(GOODS_RECEIPT_STATUSES);
...
export const THREE_WAY_MATCH_STATUS_MAP = toEnumMap(THREE_WAY_MATCH_STATUSES);
...
export const VENDOR_RISK_LEVEL_MAP = toEnumMap(VENDOR_RISK_LEVELS);
...
export const DEPENDENCY_TYPE_MAP = toEnumMap(DEPENDENCY_TYPES);
...
export const DEPENDENCY_STATUS_MAP = toEnumMap(DEPENDENCY_STATUSES);
...
export const GOVERNANCE_DOMAIN_MAP = toEnumMap(GOVERNANCE_DOMAINS);
...
export const GOVERNANCE_ACTION_MAP = toEnumMap(GOVERNANCE_ACTIONS);
...
export const LOCATION_TYPE_MAP = toEnumMap(LOCATION_TYPES);
...
export const LOCATION_OWNERSHIP_MAP = toEnumMap(LOCATION_OWNERSHIP_TYPES);
...
export const PROJECT_LOCATION_ROLE_MAP = toEnumMap(PROJECT_LOCATION_ROLES);
...
export const SPACE_BOOKING_TYPE_MAP = toEnumMap(SPACE_BOOKING_TYPES);
...
export const LOCATION_DOC_TYPE_MAP = toEnumMap(LOCATION_DOC_TYPES);
...
export const LOCATION_INSPECTION_TYPE_MAP = toEnumMap(LOCATION_INSPECTION_TYPES);
...
export const LOCATION_COST_TYPE_MAP = toEnumMap(LOCATION_COST_TYPES);
...
export const LOCATION_COST_FREQUENCY_MAP = toEnumMap(LOCATION_COST_FREQUENCIES);
...
export const LOCATION_CONTACT_ROLE_MAP = toEnumMap(LOCATION_CONTACT_ROLES);
...
export const AUTH_METHOD_MAP = toEnumMap(AUTH_METHODS);
...
export const LOGIN_EVENT_TYPE_MAP = toEnumMap(LOGIN_EVENT_TYPES);
...
export const RETENTION_ACTION_MAP = toEnumMap(RETENTION_ACTIONS);
...
export const PREFERENCE_CATEGORY_MAP = toEnumMap(PREFERENCE_CATEGORIES);
...
export const ASSET_CLASS_MAP = toEnumMap(ASSET_CLASSES);
...
export const WAREHOUSE_ZONE_TYPE_MAP = toEnumMap(WAREHOUSE_ZONE_TYPES);
...
export const WAREHOUSE_LOCATION_TYPE_MAP = toEnumMap(WAREHOUSE_LOCATION_TYPES);
...
export const SHIPMENT_ITEM_CONDITION_MAP = toEnumMap(SHIPMENT_ITEM_CONDITIONS);
...
export const SCAN_TYPE_MAP = toEnumMap(SCAN_TYPES);
...
export const SCAN_METHOD_MAP = toEnumMap(SCAN_METHODS);
...
export const LOGISTICS_EVENT_TYPE_MAP = toEnumMap(LOGISTICS_EVENT_TYPES);
...
export const DAMAGE_TYPE_MAP = toEnumMap(DAMAGE_TYPES);
...
export const MAINTENANCE_FREQUENCY_TYPE_MAP = toEnumMap(MAINTENANCE_FREQUENCY_TYPES);
...
export const MAINTENANCE_FREQUENCY_UNIT_MAP = toEnumMap(MAINTENANCE_FREQUENCY_UNITS);
...
export const DEPRECIATION_METHOD_MAP = toEnumMap(DEPRECIATION_METHODS);
...
export const INVENTORY_AUDIT_TYPE_MAP = toEnumMap(INVENTORY_AUDIT_TYPES);
...
export const DISPOSAL_METHOD_MAP = toEnumMap(DISPOSAL_METHODS);
...
export const FUEL_TYPE_MAP = toEnumMap(FUEL_TYPES);
...
export const ASSET_RETURN_CONDITION_MAP = toEnumMap(ASSET_RETURN_CONDITIONS);
...
export const COMMAND_POSITION_TYPE_MAP = toEnumMap(COMMAND_POSITION_TYPES);
...
export const VIP_STATUS_MAP = toEnumMap(VIP_STATUSES);
...
export const STRIKE_STEP_STATUS_MAP = toEnumMap(STRIKE_STEP_STATUSES);
...
export const COMM_CHANNEL_PRIORITY_MAP = toEnumMap(COMM_CHANNEL_PRIORITIES);
...
export const BOM_ITEM_TYPE_MAP = toEnumMap(BOM_ITEM_TYPES);
...
export const RIGHTS_STATUS_MAP = toEnumMap(RIGHTS_STATUSES);
...
export const WP_DEPENDENCY_TYPE_MAP = toEnumMap(WP_DEPENDENCY_TYPES);
...
export const SETTING_SCOPE_MAP = toEnumMap(SETTING_SCOPES);
...
export const SETTING_VALUE_TYPE_MAP = toEnumMap(SETTING_VALUE_TYPES);
...
export const SETTING_CATEGORY_MAP = toEnumMap(SETTING_CATEGORIES);
...
export const FEATURE_FLAG_TYPE_MAP = toEnumMap(FEATURE_FLAG_TYPES);
...
export const FEATURE_FLAG_OVERRIDE_SCOPE_MAP = toEnumMap(FEATURE_FLAG_OVERRIDE_SCOPES);
...
export const PERMISSION_ACTION_MAP = toEnumMap(PERMISSION_ACTIONS);
...
export const PERMISSION_SCOPE_TYPE_MAP = toEnumMap(PERMISSION_SCOPE_TYPES);
...
export const PRICING_TIER_MAP = toEnumMap(PRICING_TIERS);
...
export const SUBSCRIPTION_STATUS_MAP = toEnumMap(SUBSCRIPTION_STATUSES);

export const BILLING_CYCLES = [
    { value: "monthly", label: "Monthly", variant: "default" as const },
    { value: "annual", label: "Annual", variant: "info" as const },
] as const;
export const BILLING_CYCLE_MAP = toEnumMap(BILLING_CYCLES);
...
export const FIELD_VISIBILITY_MAP = toEnumMap(FIELD_VISIBILITIES);
...
export const FIELD_WRITE_ACCESS_MAP = toEnumMap(FIELD_WRITE_ACCESSES);
...
export const SETTINGS_APPROVAL_STATUS_MAP = toEnumMap(SETTINGS_APPROVAL_STATUSES);
...
export const INVITATION_TYPE_MAP = toEnumMap(INVITATION_TYPES);
...
export const CONVERSATION_TYPE_MAP = toEnumMap(CONVERSATION_TYPES);
...
export const CONVERSATION_MEMBER_ROLE_MAP = toEnumMap(CONVERSATION_MEMBER_ROLES);
...
export const MESSAGE_PRIORITY_MAP = toEnumMap(MESSAGE_PRIORITIES);
...
export const NOTIFICATION_PREFERENCE_LEVEL_MAP = toEnumMap(NOTIFICATION_PREFERENCE_LEVELS);
...
export const CATALOG_CATEGORY_TYPE_MAP = toEnumMap(CATALOG_CATEGORY_TYPES);
...
export const CATALOG_ITEM_STATUS_MAP = toEnumMap(CATALOG_ITEM_STATUSES);
...
export const MODIFIER_TYPE_MAP = toEnumMap(MODIFIER_TYPES);
...
export const PRICE_ADJUSTMENT_TYPE_MAP = toEnumMap(PRICE_ADJUSTMENT_TYPES);
...
export const ADVANCE_STATUS_MAP = toEnumMap(ADVANCE_STATUSES);
...
export const ADVANCE_PRIORITY_MAP = toEnumMap(ADVANCE_PRIORITIES);
...
export const ADVANCE_ITEM_STATUS_MAP = toEnumMap(ADVANCE_ITEM_STATUSES);
...
export const CREDENTIAL_CATEGORY_MAP = toEnumMap(CREDENTIAL_CATEGORIES);
...
export const CREDENTIAL_ASSIGNMENT_STATUS_MAP = toEnumMap(CREDENTIAL_ASSIGNMENT_STATUSES);
...
export const BULK_JOB_STATUS_MAP = toEnumMap(BULK_JOB_STATUSES);
...
export const USER_CERTIFICATION_TYPE_MAP = toEnumMap(USER_CERTIFICATION_TYPES);
...
export const SHEET_STATUS_MAP = toEnumMap(SHEET_STATUSES);
