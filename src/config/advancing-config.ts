...
export const ADVANCE_STATUSES: EnumConfig<AdvanceStatus>[] = [
    { value: "draft", label: "Draft", variant: "ghost", icon: Circle, description: "Not yet submitted" },
    { value: "submitted", label: "Submitted", variant: "info", icon: Send, description: "Awaiting review" },
    { value: "in_review", label: "In Review", variant: "warning", icon: Clock, description: "Under approval review" },
    { value: "approved", label: "Approved", variant: "success", icon: CheckCircle2, description: "Approved, ready for fulfillment" },
    { value: "in_progress", label: "In Progress", variant: "default", icon: Loader2, description: "Being fulfilled" },
    { value: "fulfilled", label: "Fulfilled", variant: "info", icon: PackageCheck, description: "All items delivered" },
    { value: "completed", label: "Completed", variant: "success", icon: FileCheck, description: "Advance closed out" },
    { value: "cancelled", label: "Cancelled", variant: "destructive", icon: X, description: "Cancelled" },
];
...
export const ADVANCE_ITEM_STATUSES: EnumConfig<AdvanceItemStatus>[] = [
    { value: "pending", label: "Pending", variant: "ghost", icon: Circle, description: "Awaiting confirmation" },
    { value: "confirmed", label: "Confirmed", variant: "info", icon: CircleDot, description: "Vendor confirmed" },
    { value: "in_transit", label: "In Transit", variant: "warning", icon: Truck, description: "En route to venue" },
    { value: "delivered", label: "Delivered", variant: "info", icon: Package, description: "On-site, not installed" },
    { value: "installed", label: "Installed", variant: "default", icon: Settings2, description: "Set up at location" },
    { value: "operational", label: "Operational", variant: "success", icon: Play, description: "Active and in use" },
    { value: "struck", label: "Struck", variant: "warning", icon: Pause, description: "Torn down post-show" },
    { value: "returned", label: "Returned", variant: "info", icon: Undo2, description: "Back to vendor/warehouse" },
    { value: "complete", label: "Complete", variant: "success", icon: CheckCircle2, description: "Line item closed" },
];
...
export function canTransitionAdvanceItem(current: AdvanceItemStatus, next: AdvanceItemStatus): boolean {
...
export const ADVANCE_TYPES: EnumConfig<AdvanceType>[] = [
    { value: "pre_event", label: "Pre-Event", variant: "info", description: "Pre-production ordering" },
    { value: "load_in", label: "Load-In", variant: "warning", description: "Load-in day requirements" },
    ...
    { value: "post_event", label: "Post-Event", variant: "ghost", description: "Post-event wrap items" },
];
