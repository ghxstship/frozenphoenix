...
export const FK_LOOKUP_CONFIGS: Record<string, EntityLookupConfig> = {
    ...
    approver_id: { apiPath: "/api/profiles", labelField: "display_name", secondaryField: "email" },
    ...
    grantee_id: { apiPath: "/api/profiles", labelField: "display_name", secondaryField: "email" },
    payment_id: { apiPath: "/api/payments", labelField: "reference_number" },
    profile_id: { apiPath: "/api/profiles", labelField: "display_name", secondaryField: "email" },
    ...
    signer_id: { apiPath: "/api/profiles", labelField: "display_name", secondaryField: "email" },
    ...
    subject_id: { apiPath: "/api/profiles", labelField: "display_name", secondaryField: "email" },
    survey_template_id: { apiPath: "/api/templates", labelField: "name" },
    trigger_id: { apiPath: "/api/automations", labelField: "name" },
    user_id: { apiPath: "/api/profiles", labelField: "display_name", secondaryField: "email" },
