...
export const MOCK_DEALS: Deal[] = [
    ...
    {
        id: "d7",
        title: "Conference Expo Build",
        company: "Salesforce",
        contactName: "Tom Brady",
        contactEmail: "tom@salesforce.com",
        value: 650000,
        stage: "lost",
        probability: 0,
        expectedCloseDate: "2026-02-01",
        assignedTo: "Alex Rivera",
        notes: "Went with competitor pricing",
...
export const MOCK_PROJECTS: Project[] = [
    {
        id: "p1",
        name: "Coachella Main Stage 2026",
        client: "Coachella",
        status: "active",
        currentPhase: "fabrication",
        startDate: "2026-01-15",
        endDate: "2026-04-10",
        budgetPlanned: 3500000,
    ...
    {
        id: "p2",
        name: "Glossier Pop-Up NYC",
        client: "Glossier",
        status: "active",
        currentPhase: "load_in",
        startDate: "2026-02-01",
        endDate: "2026-03-15",
        budgetPlanned: 175000,
        budgetActual: 160000,
        progress: 85,
        managerId: "u2",
        teamIds: ["u2", "u4"],
...
export const MOCK_TASKS: Task[] = [
    ...
    },
    {
        id: "t2",
        projectId: "p1",
        title: "LED Panel Array Installation",
        status: "todo",
        priority: "high",
        assigneeId: "u2",
        phase: "fabrication",
    ...
    },
    {
        id: "t3",
        projectId: "p1",
        title: "Audio System Rigging Plan",
        status: "done",
        priority: "high",
    ...
    },
    {
        id: "t6",
        projectId: "p1",
        title: "Freight Logistics — Stage Components",
        status: "backlog",
        priority: "high",
        phase: "logistics",
        dependencies: ["t1", "t2"],
...
export const MOCK_ASSETS: Asset[] = [
    ...
    },
    {
        ...
        ownedOrRental: "rental",
        rentalReturnDate: "2026-03-05",
        dailyRentalCost: 350,
    },
    {
        id: "a4",
        name: "Staging Deck 4x8",
        category: "Staging",
        barcode: "FP-ST-022",
        condition: "fair",
        location: "Warehouse A",
...
export const MOCK_VEHICLES: Vehicle[] = [
    {
        ...
        name: "Sprinter Van #1",
        type: "Cargo Van",
        licensePlate: "FP-2201",
        dockHeight: "24in",
        driverName: "Carlos Reyes",
        driverPhone: "(555) 300-1001",
        gpsEnabled: true,
        status: "available",
    },
    {
        ...
        name: "53ft Flatbed",
        type: "Semi Trailer",
        licensePlate: "FP-5301",
        dockHeight: "48in",
        driverName: "Mike Thompson",
        driverPhone: "(555) 300-1002",
        gpsEnabled: true,
        status: "in_transit",
    },
    {
        ...
        name: "Box Truck #3",
        type: "Box Truck",
        licensePlate: "FP-3303",
        dockHeight: "36in",
        driverName: "Sarah Lee",
        driverPhone: "(555) 300-1003",
        gpsEnabled: true,
        status: "loading",
    },
];
...
export const MOCK_VENDORS: Vendor[] = [
    ...
    {
        id: "vn2",
        name: "PrintMax Studio",
        contactName: "Linda Chang",
        email: "linda@printmax.com",
        phone: "(555) 400-1002",
        specialty: "Large Format Printing",
        coiExpiryDate: "2026-06-15",
        coiValid: true,
        ndaSigned: true,
        w9Uploaded: true,
        rating: 4.5,
    ...
    },
    {
        id: "vn3",
        name: "Bolt Electric",
        contactName: "Ray Santos",
        email: "ray@boltelectric.com",
        phone: "(555) 400-1003",
        specialty: "Electrical",
        coiExpiryDate: "2025-12-01",
        coiValid: false,
        ndaSigned: false,
        w9Uploaded: true,
        rating: 4.2,
...
export const MOCK_APPROVALS: Approval[] = [
    {
        ...
        projectId: "p1",
        milestoneId: "m1",
        milestoneName: "Stage Design Concept",
        status: "approved",
        requestedAt: "2026-01-20T00:00:00Z",
        deadline: "2026-01-23T00:00:00Z",
        approvedAt: "2026-01-22T00:00:00Z",
    ...
    },
    {
        ...
        projectId: "p1",
        milestoneId: "m2",
        milestoneName: "Fabrication Blueprint",
        status: "pending",
        requestedAt: "2026-02-22T00:00:00Z",
    ...
    },
    {
        ...
        projectId: "p2",
        milestoneId: "m3",
        milestoneName: "Interior Layout Final",
        status: "overdue",
        requestedAt: "2026-02-18T00:00:00Z",
        deadline: "2026-02-21T00:00:00Z",
        approverName: "Emma Liu",
...
export const MOCK_NOTIFICATIONS: Notification[] = [
    {
        ...
        message: "Interior Layout Final for Glossier Pop-Up is 3 days overdue",
        type: "warning",
        read: false,
        actionUrl: "/approvals",
    ...
    },
    {
        id: "n2",
        title: "COI Expired",
        message: "Bolt Electric's Certificate of Insurance has expired",
        type: "error",
        read: false,
        actionUrl: "/vendors",
    ...
    },
    {
        ...
        message: "Generator 50kW rental return due in 9 days",
        type: "info",
        read: true,
        actionUrl: "/assets",
    ...
    },
    {
        id: "n4",
        title: "Deal Won!",
        message: "Coachella Main Stage deal closed at $3.5M",
        type: "success",
        read: true,
...
export const MOCK_CASE_STUDIES: CaseStudy[] = [
    {
        id: "cs1",
        projectId: "p-old-1",
        title: "Burning Man Art Collective 2025",
        client: "Black Rock Arts Foundation",
        summary:
            "A 40ft interactive kinetic sculpture combining steel fabrication with responsive LED arrays, installed in the deep playa.",
        metrics: [
            { label: "On-Time", value: "100%" },
            { label: "Budget Variance", value: "-2%" },
            { label: "Attendee Interactions", value: "45,000+" },
        ],
        photos: [],
        status: "published",
