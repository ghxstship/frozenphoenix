...
const MOCK_TESTIMONIALS: Testimonial[] = [
    {
        ...
        quote: "Frozen Phoenix transformed our product launch into an unforgettable experience. Their attention to detail and creative vision exceeded all expectations.",
...
const MOCK_REVIEWS: Review[] = [
    {
        ...
        content: "We've worked with Frozen Phoenix on three major events now. Each one has been flawlessly executed.",
