...
export const useDocuments = makeListHook<Tables<"documents">>("document", "/api/documents", {
    sort_by: "updated_at",
    sort_order: "desc",
});
export const useDocument = makeDetailHook<Tables<"documents">>("document", "/api/documents");
export const useCreateDocument = makeCreateHook<Tables<"documents">>("document", "/api/documents");
export const useUpdateDocument = makeUpdateHook<Tables<"documents">>("document", "/api/documents");
export const useDeleteDocument = makeDeleteHook("document", "/api/documents");
...
export const useDeleteVaultDocument = makeDeleteHook("vault_document", "/api/vault-documents");
...
export const useDeleteDocumentTemplate = makeDeleteHook("document_template", "/api/templates");
...
export const useBrandKits = makeListHook<Tables<"brand_kits">>("brand_kit", "/api/brand-kits", {
    sort_by: "client_name",
    sort_order: "asc",
});
...
export const useBriefs = makeListHook<Tables<"creative_briefs">>("creative_brief", "/api/briefs", {
    sort_by: "created_at",
    sort_order: "desc",
});
...
export const useDecks = makeListHook<Tables<"decks">>("deck", "/api/decks", {
    sort_by: "created_at",
    sort_order: "desc",
});
...
export const useSOPs = makeListHook<Tables<"sops">>("sop", "/api/sops", {
    sort_by: "title",
    sort_order: "asc",
});
export const useSOP = makeDetailHook<Tables<"sops">>("sop", "/api/sops");
export const useCreateSOP = makeCreateHook<Tables<"sops">>("sop", "/api/sops");
export const useUpdateSOP = makeUpdateHook<Tables<"sops">>("sop", "/api/sops");
export const useDeleteSOP = makeDeleteHook("sop", "/api/sops");
...
export const useCampaigns = makeListHook<Tables<"campaigns">>("campaign", "/api/campaigns", {
    sort_by: "start_date",
    sort_order: "desc",
});
